...
?>
    ...
    <!-- =========================== header  ========================= -->
    <h1 align="center"> "<?php echo $testname; ?>" </h1>
    <!-- //=========================================================== -->

    <!--===================== header control form ====================-->
    <form action="save_test.php" method="POST" >
         <div  style= "background-color: #C0C0C0; width:99%; margin-left : 8px; padding:10px"> <!--class="container" -->
    ...
    <div style= "width:99%; margin-left : 8px; ">
        ...
        <?php
            ...
            //==================== show saved questions for the test ==============       
            if($count > 0)
            {
                $counter = 1;
                    ...
                    if(isset($angl_cont))
                    {
                        if($angl_cont < 0 )
                            ...
                            if($angl_cont  == $counter)
                            {
                                ...
                                if( $angl_msg == "Зміна питання")
                                    ShowInfo( $angl_msg . " № " . $counter , $angl_err );  
                                else
                                    ShowInfo( $angl_msg , $angl_err ); 

                                if( $angl_msg == "Зміна питання"){
                                    $reson = false;
                                     echo "<hr noshade   style = \"height: 3px;\"> <br>";
                                     ShowConstructorQvestions($conection,  $test_id, $row['id_question'] , $counter);
                                     echo "<br>";
                                }
        ...
        <div class="row" >
            ...
            <div class="col-8" id="main_form" style="display:none">
                <?php ShowConstructorQvestions($conection, $test_id, NULL, NULL); ?>
            </div>
            <!-- ===============================================================-->
...
<?php
    ...
    function Showqvestions($counter, $row)
    {
        ...
        $question_impot =       $row['question_impot'];
        $test_id =              $row['test_id'];
    ...
    function ShowConstructorQvestions($conection,  $test_id ,  $id_question, $counter)
    {
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">     
                                                <select name='type_quest' class="form-control" id="exampleFormControlSelect1" onchange="f_type_quest(value)" >
                                                    ...
                                                    <!-- <option value="ratio">Співвідношення</option> ---in procesing develop--- -->
                                                </select>                               
                                            </div>
                                        </div>
